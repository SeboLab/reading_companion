...
//same as first page! again another brute force way to get it working! there's definitely cleaner
// ways to get it to work
public class SecondPage extends AppCompatActivity implements TCPClientOwner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String paragraph = getString(Global.getInstance().getWords2());
